...
class CharacterMap:
    ...
    def add_map(self, row, col, added_array, exclude_chars:tuple=(' ',)):
        ...
        self.array[start_row:end_row, start_col:end_col] = added_array[local_start_row:local_end_row, local_start_col:local_end_col]
        
        mask = ~np.isin(self.array[start_row:end_row, start_col:end_col], exclude_chars)
...
class TerminalDisplay:
    ...
    def update(self, display_map:CharacterMap, stay_seconds=0):
...
if __name__ == "__main__":
    ...
    for i in range(len(CHAR_LIST)):
        ...
        display_map.add_map(col=char_top_left_display_col, row=char_top_left_display_row-i, added_array=i_char_map.array)
